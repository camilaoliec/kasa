    ...
    <div className="fiche-logement">
      <Slideshow images={appartement.pictures} />
        <div className="fiche-logement__info">
          ...
          {appartement.tags.map((tag, index) => (
            <div key={index} className="fiche-logement__tag"><p>{tag}</p></div>
          ))}            
        </div>
      </div>
      {/* Rigth: Host e Rating */}
      <div className="fiche-logement__info-right">
        ...
        <div className="fiche-logement__host">   
          <p className="fiche-logement__host-name">{appartement.host.name}</p>
          <img
        ...
        <div className="fiche-logement__rating">
          {Array.from({ length: 5 }, (_, i) => (
            ...
            className={`fiche-logement__star ${i < appartement.rating ? "active" : "inactive"}`}
          />
          ))}
        </div>
      </div>
